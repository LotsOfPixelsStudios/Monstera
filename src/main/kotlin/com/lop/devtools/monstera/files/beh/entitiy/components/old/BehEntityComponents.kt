...
class BehEntityComponents : MonsteraFile {
    ...
    fun color(data: ComponentValue.() -> Unit) {
        unsafe.general["minecraft:color"] = ComponentValue().apply(data)
    }
    ...
    fun color2(data: ComponentValue.() -> Unit) {
        unsafe.general["minecraft:color2"] = ComponentValue().apply(data)
    }
    ...
    fun flyingSpeed(data: ComponentValue.() -> Unit) {
        unsafe.general["minecraft:flying_speed"] = ComponentValue().apply(data)
    }
    ...
    fun lavaMovement(data: ComponentValue.() -> Unit) {
        unsafe.general["minecraft:lava_movement"] = ComponentValue().apply(data)
    }
    ...
    fun movement(data: ComponentValue.() -> Unit) {
        unsafe.general["minecraft:movement"] = ComponentValue().apply(data)
    }
    ...
    fun playerSaturation(data: ComponentValue.() -> Unit) {
        unsafe.general["minecraft:player.saturation"] = ComponentValue().apply(data)
    }
    ...
    fun scale(data: ComponentValue.() -> Unit) {
        unsafe.general["minecraft:scale"] = ComponentValue().apply(data)
    }
    ...
    fun underwaterMovement(data: ComponentValue.() -> Unit) {
        unsafe.general["minecraft:underwater_movement"] = ComponentValue().apply(data)
    }
    ...
    fun defaultLookAngle(data: ComponentValue.() -> Unit) {
        unsafe.general["minecraft:default_look_angle"] = ComponentValue().apply(data)
    }
    ...
    fun footSize(data: ComponentValue.() -> Unit) {
        unsafe.general["minecraft:foot_size"] = ComponentValue().apply(data)
    }
    ...
    fun frictionModifier(data: ComponentValue.() -> Unit) {
        unsafe.general["minecraft:friction_modifier"] = ComponentValue().apply(data)
    }
    ...
    fun groundOffset(data: ComponentValue.() -> Unit) {
        unsafe.general["minecraft:ground_offset"] = ComponentValue().apply(data)
    }
    ...
    fun pushTrough(data: ComponentValue.() -> Unit) {
        unsafe.general["minecraft:push_through"] = ComponentValue().apply(data)
    }
    ...
    fun soundVolume(data: ComponentValue.() -> Unit) {
        unsafe.general["minecraft:sound_volume"] = ComponentValue().apply(data)
    }
    ...
    fun walkAnimationSpeed(data: ComponentValue.() -> Unit) {
        unsafe.general["minecraft:walk_animation_speed"] = ComponentValue().apply(data)
    }
    ...
    fun movementSoundDistanceOffset(data: ComponentValue.() -> Unit) {
        unsafe.general["minecraft:movement_sound_distance_offset"] = ComponentValue().apply(data)
    }
